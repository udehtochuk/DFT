# Total-Energy Retention Can Mask Fluctuation Reconstruction Error

**DC Dominance in DFT Coefficient Selection**

Analysis code, recovered dataset and reproducible workflow for the manuscript
of the same name by Udeh Tochukwu L. (ORCID 0000-0003-0066-0618).

Run `python code/reproduce_all.py` to regenerate every number, table and
figure reported in the paper. Runtime is about 12 seconds.
